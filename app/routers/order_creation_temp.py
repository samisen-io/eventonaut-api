...
from app.crud.conferences_crud import get_conference_by_id
from app.crud.master_template_crud import get_master_template_by_id
from app.crud.registration_order_crud_temp import create_registration_order_temp, get_registration_order_by_id, update_registration_order
from app.crud.registration_order_item_crud import create_registration_order_item
from app.crud.registration_setup_crud_temp import create_registration_setup, get_registration_setup
from app.crud.registration_setup_item_crud_temp import create_registration_setup_item, get_registration_setup_item, update_registration_setup_item
...
from app.schemas.registration_order_schema_temp import RegistrationOrderCreateTemp
...
router = APIRouter(tags=["order_creation_temporary"])

@router.post("/create-registration-setup/")
...
@router.post("/create-registration-setup-item/")
...
@router.post("/create-registration-order/")
...
@router.post("/create-registration-order-item", response_model=RegistrationOrderItem)
