...
@router.get("/conferences/start_date/{start_date}", response_model=schemas.Conference)
...
@router.get("/conferences/end_date/{end_date}", response_model=schemas.Conference)
